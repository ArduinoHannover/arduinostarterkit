/*******************************************************************************/
/* RDA5807M_Radio_I    - Die Ausgabe der im setup() erkannten I2C Adressen des
...
const char* sketchname            =  "RDA5807M_Radio_I";
const char* revision              =  "R.1.0";
const char* author                =  "Olaf Meier";
const char* date                  =  "2016/01/25";
...
void setup() {
  ...
  Wire.beginTransmission(RDA5807_ADR_S);
  ...
  /***  Nach Initialisierung erfolgt das Sendertuning  ***/
